...
userinfo_endpoint = (rq.get(f'{keycloak}/auth/realms/{server}-gw/.well-known/openid-configuration').json())['userinfo_endpoint']
        ...
        # offer to install
            ...
            if nameOk and st.button('INSTALL', key=repo.id):
                ...
                with st.spinner('in progress'):
                    ...
                    ret = rqpostAuth(f'{scriptHandler}/repo/import', token, json.dumps(postData))
                st.write('Done!')
